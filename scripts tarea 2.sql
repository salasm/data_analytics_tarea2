...
#NIVEL 2
#Ejercicio 1: Identificar los cinco días que se generó la mayor cantidad de ingresos en la empresa por ventas y mostrar la fecha de cada transacción junto con el total de las ventas.
